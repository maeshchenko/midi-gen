...
**13 жанров:** Classic Keygen · Grime · Drift Phonk · Noir (dark jazz) · Anime Opening · Blues · Military Parade · Dark Academia · Nightcore · Music Box · Eurobeat · Outrun · Grime Run.
...
Для ритм-игр есть отдельный гайд — [docs/GAME.md](docs/GAME.md): жанры с «битмап-контрактом» (`outrun`, `eurobeat`, `grimerun` — онсеты строго на сетке 1/32, арка громкости под рельеф), длина трека через `minutes`, блоки/рельеф/скорость прямо из Song IR без аудио-анализа.
